...
def get_trade_parameters(trade) -> Trade_Parameters: #forces Object of Type Trade_Parameters as Output
    with st.container(border=True):
        ...
        with st.expander("Main Inputs"):
            ...
            t.total_max_margin = st.number_input("total_max_margin: ", value = t.total_max_margin if t.total_max_margin >= 0.0 else 0.0, min_value = 1.0, step = 1.0, key ="input_total_max_margin")
